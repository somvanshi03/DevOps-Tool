...
### 4. **User  Space**
	...
	- **User  Applications**: Software programs that users interact with, such as web browsers, 
...
### 2. **Common Directories Under Root**
	...
	- **`/bin`**: Contains essential binary executables (commands) that are required for the 
